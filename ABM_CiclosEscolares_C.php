...
function altaCiclosEscolares ($dbConn, $data) {
...
function consCiclosEscolares($dbConn) {
  $statement = $dbConn->prepare("SELECT * FROM eegetm002");
  $statement->execute();
