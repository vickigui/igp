        ...
        foreach ($conceptosCargo as $concepto) {
          ...
          if ($concepto['id'] == 1) {
            if ($cargo['P_HORA'] == 'N') {
              ...
              $arraySueldo[] = ['Descripcion' => $concepto['T_DESC'], 'Valor' => $BC / $cargo['N_HORA_EQUI'] * $legajo['N_CANT_HORA']];
            }
          //Fórmula Antigüedad
          ...
          if ($conceptoBR2 < 2) {
            if ($cargo['P_HORA'] == 'N') {
              ...
              $arraySueldo[] = ['Descripcion' => $concepto['T_DESC'], 'Valor' => $BR2 /  $cargo['N_HORA_EQUI'] * $legajo['N_CANT_HORA']];
              $conceptoBR2 = $conceptoBR2 + 1;
            }
          }
          ...
          if ($cargo['P_HORA'] == 'S') {
            if ($conceptoBoniNoJerar < 2) {
              $arraySueldo[] = ['Descripcion' => $concepto['T_DESC'], 'Valor' => $BC * $legajo['N_CANT_HORA'] / $cargo['N_HORA_EQUI'] * 32 / 100];
          ...
          if ($conceptoBNR1 < 2) {
            if ($cargo['P_HORA'] == 'N') {
              ...
              $arraySueldo[] = ['Descripcion' => $concepto['T_DESC'], 'Valor' => $BNR1 / $cargo['N_HORA_EQUI'] * $legajo['N_CANT_HORA']];
              $conceptoBNR1 = $conceptoBNR1 + 1;
            }
          }
          ...
          if ($conceptoBNR2 < 2) {
            if ($cargo['P_HORA'] == 'N') {
              ...
              $arraySueldo[] = ['Descripcion' => $concepto['T_DESC'], 'Valor' => $BNR2 / $cargo['N_HORA_EQUI'] * $legajo['N_CANT_HORA']];
              $conceptoBNR2 = $conceptoBNR2 + 1;
            }
          }
